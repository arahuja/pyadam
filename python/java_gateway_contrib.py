...
def launch_gateway():
    ...
    # USE THE LOCAL spark-class script to launch the gateway
    # This version allows you specify additional jars to add on the class path

    script = "./bin/spark-class.cmd" if on_windows else "./spark-class"
    command = [os.path.join(os.getcwd(), script), "py4j.GatewayServer",
    ...
    java_import(gateway.jvm, "org.bdgenomics.adam.python.*")
